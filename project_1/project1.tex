...
\end{equation}
where $d_L$ is the luminosity distance in megaparsecs (Mpc). The luminosity distance depends on the cosmological parameters and can be expressed in terms of the Hubble constant $H_0$ and the deceleration parameter $q_0$.
\section{Methodology}
