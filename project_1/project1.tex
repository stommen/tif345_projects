...
\vspace{-1.2cm}
\section{Discussion}
Earlier measurements place $H_0$ near $70~\mathrm{km\,s^{-1}\,Mpc^{-1}}$ \cite{expvalue_H0} and $q_0$ around $-0.6\pm0.2$ \cite{expvalue_q0}, consistent with the corner-plot estimates. A very-low-$z$ ($z<0.05$) Hubble-law check gives $H_0 = 68.31 \pm 5.75~\mathrm{km\,s^{-1}\,Mpc^{-1}}$, supporting the distance-modulus calibration and the $H_0$ extraction. Together with $\sigma_\mathrm{sys}^{2}\approx 1$ and the decisively negative $q_0$, this provides robust evidence for acceleration.
